...
Entity::Entity(const int val)
{
    id = val;
    tag = Tag::robot;
}

Entity::Entity(const char val)
{
    letter = val;
    tag = Tag::human;
}

Entity::Entity(const std::string val)
{
    letter = val[0];
    tag = Tag::human;
}

Entity::Entity(const double val)
{
    wavelength = val;
    tag = Tag::alien;
}
...
void Entity::set_union(const std::string value) {
    letter = value[0];
    tag = Tag::human;
}
